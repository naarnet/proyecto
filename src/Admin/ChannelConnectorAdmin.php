...
class ChannelConnectorAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ->with('Channel', array(
                ...
                'description' => 'Selecccione el Marketplace',
            ))
            ->add('marketplace', ModelListType::class, array(
                'label' => 'MarkePlace',
                'required' => true,
                'help' => 'Marketplace'
            ))
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $user = $this->getUser();
        $datagridMapper
            ->add('marketplace', null, array('label' => 'Name'));
